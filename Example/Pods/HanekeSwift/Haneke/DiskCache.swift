...
open class DiskCache {
    ...
    open func removeAllData() {
        ...
        cacheQueue.async(execute: {
            do {
                ...
                Log.error(error as NSError, "Failed to list directory")
            }
        })
    }
    ...
    fileprivate func updateDiskAccessDateAtPath(_ path: String) -> Bool {
        ...
        do {
            ...
            Log.error(error as NSError, "Failed to update access date")
            return false
        }
    }
    ...
    fileprivate func removeFileAtPath(_ path: String) {
        ...
        do {
            ...
            do {
                ...
                Log.error(error as NSError, "Failed to remove file")
            }
        } catch {
            let castedError = error as NSError
            if isNoSuchFileError(castedError) {
                Log.debug(castedError, "File not found")
            } else {
                Log.error(castedError, "Failed to remove file")
            }
        }
    }
}
